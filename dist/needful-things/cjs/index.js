...
var TelLink = /** @class */ (function (_super) {
    ...
    Object.defineProperty(TelLink.prototype, "callableTel", {
        get: function () {
...
function applyFaviconLinks(options) {
    ...
    var _a = options.path, path = _a === void 0 ? '/static/icons' : _a, _b = options.manifestPath, manifestPath = _b === void 0 ? '/static/manifest.json' : _b, _c = options.color, color = _c === void 0 ? '#FFFFFF' : _c;
    return [
        {
...
function applyFaviconMetaTags(options) {
    if (options === void 0) { options = {}; }
    var _a = options.name, name = _a === void 0 ? '' : _a, _b = options.path, path = _b === void 0 ? '/static/icons' : _b, _c = options.color, color = _c === void 0 ? '#FFFFFF' : _c, _d = options.statusBarStyle, statusBarStyle = _d === void 0 ? 'default' : _d;
    return [
...
exports.EmailLink = __vue_component__;
exports.TelLink = __vue_component__$1;
exports.applyFacebookMetaTags = applyFacebookMetaTags;
exports.applyFaviconLinks = applyFaviconLinks;
exports.applyFaviconMetaTags = applyFaviconMetaTags;
exports.applySplashscreenLinks = applySplashscreenLinks;
exports.applyTwitterMetaTags = applyTwitterMetaTags;
