...
function () {
  ...
  _createClass(Tinify, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee() {
        var choices, _ref, selectedFiles, _ref2, compress, addCompressFlag, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _loop, _iterator, _step;
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 10:
                          ...
                          fs.writeFileSync("".concat(dir, "/").concat(name).concat(compressFlag).concat(ext), result);
                          spinner.succeed();
        ...
        }, _callee, this, [[18, 28, 32, 40], [33,, 35, 39]]);
      }));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                curPath = '';
                return _context3.abrupt("return", reduce_1(files, function (result, value, key) {
